    ...
    public static class SeedData
    {
        public static void SeedDatabase(DataContext context)
        {
            ...
            if (!context.Products.Any() && !context.Categories.Any() && !context.Suppliers.Any())
            {
                ...
                Category c1 = new Category { Name = "WaterSport" };
                ...
                context.Products.AddRange(
                    ...
                    new Product { Name = "Stadium", Price = 79500m, Category = c2, Supplier = s2 },
                    new Product { Name = "Thinking Cap", Price = 16m, Category = c3, Supplier = s3 },
                    new Product { Name = "Unsteady Chair", Price = 29.95m, Category = c3, Supplier = s3 },
                    new Product { Name = "Human Chess Board", Price = 75m, Category = c3, Supplier = s3 },
                    new Product { Name = "Bling-Bling King", Price = 1200m, Category = c3, Supplier = s3 });
